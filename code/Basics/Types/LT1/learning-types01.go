...
// variables declarations may be "factored" into blocks (as with import statements)
var (
	// bool - boolean is true or false (lower case)
	kirk bool = false
	// uint64 - unsigned ints with values ranging 0 to 18,446,744,073,709,551,615
	spock  uint64     = 1<<64 - 1 // Create a huge number by shifting a 1 bit left
								  // 64 places and then subtracting ONE
